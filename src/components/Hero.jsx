  ...
  return (
    <section
      ...
      style={{
        ...
        backgroundImage:
          "radial-gradient(rgba(255,255,255,.06) 1.1px, transparent 1.1px)",
    ...
    >
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(110deg, #15234F 0%, #15234F 52%, #1B2D6B 100%)",
        }}
      />
      <div
        ...
        <div>
          ...
          <span
            style={{
              ...
              animation: "ak-draw .9s .35s cubic-bezier(.16,1,.3,1) both",
            }}
          />
          <p
            style={{
          ...
          >
            Transformamos la experiencia de tu institución educativa: mejoramos
            la comunicación, la atención y la imagen para que tu colegio crezca.
          </p>
          <div
            style={{
              display: "flex",
          ...
          >
            <a
              ...
              style={{
                ...
                borderRadius: "8px",
                textDecoration: "none",
                boxShadow: "0 10px 26px rgba(201,168,76,.28)",
                transition:
          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: "13px", color: "#AFB7CE" }}>
                servicios especializados
              </span>
            </div>
            <div
              className="ak-stats-divider"
              style={{ width: "1px", background: "rgba(255,255,255,.16)" }}
            />
            <div
              style={{ display: "flex", flexDirection: "column", gap: "3px" }}
            >
          ...
          >
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(to top, rgba(15,29,74,.55) 0%, transparent 55%)",
              }}
            />
          </div>
